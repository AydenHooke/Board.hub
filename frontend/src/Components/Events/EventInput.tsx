    ...
    <>
        <section className='meetups'>
            <div className='event-header'>
              <h2 className='event-heading'>My Meetups</h2>
            ...
            <ul className='event-list'>
               {myMeetings.map((meeting) => (
                <li key={meeting.eventId} className='event-tile'>
                    <h3 className='event-title'>{meeting.title}</h3>
        ...
        <section className='tournaments'>
            ...
            <ul className='event-list'>
                {myTournaments.map((tournament) => (
                  <li key={tournament.eventId} className='event-tile'>
                      <h3>Title: {tournament.title}</h3>
                      <div className="event-line"></div>
                      <div className="event-content">
                        <img className="event-img" src="data:image/png;base64," alt="Chess Image" />
                        <p>by: {tournament.username}</p>
