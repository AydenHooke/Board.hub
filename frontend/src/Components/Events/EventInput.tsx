    ...
    <>
      <section className='meetups'>
        ...
        <ul className='event-list'>
          {
            myMeetings.length == 0 ? <>No subscribed meetups.</> :
              myMeetings.map((meeting) => (
                <li key={meeting.eventId} className='event-tile'>
                    <h3 className='event-title' style={{cursor:"pointer"}}>Title: <Link to={`/event/${meeting.eventId}`}>{meeting.title}</Link></h3>
      ...
      <section className='tournaments'>
        ...
        <ul className='event-list'>
          {
            myTournaments.length == 0 ? <>No subscribed tournaments.</> :
              myTournaments.map((tournament) => (
                <li onClick={() => navigate(`/event/${tournament.eventId}`)} key={tournament.eventId} className='event-tile'>
                  ...
                  <h3 className='event-title' style={{cursor:"pointer"}}>Title: <Link to={`/event/${tournament.eventId}`}>{tournament.title}</Link></h3>
                  <div className="event-line"></div>
                  <div className="event-content">
                    <img className="event-img" src="data:image/png;base64," alt="Chess Image" />
                    <p>By:&nbsp;
                    ...
                    {/* <button onClick={() => navigate(`/event/${tournament.eventId}`)}>View details</button> */}
